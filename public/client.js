...
var require_react_development = __commonJS({
  "node_modules/.pnpm/react@19.1.1/node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    (function() {
      ...
      function ReactElement(type, key, self, source, owner, props2, debugStack, debugTask) {
        self = props2.ref;
        type = {
  ...
  "node_modules/.pnpm/react-dom@19.1.1_react@19.1.1/node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      function validateOptionProps(element, props2) {
        null == props2.value && ("object" === typeof props2.children && null !== props2.children ? React2.Children.forEach(props2.children, function(child) {
      ...
      function describeExpandedElement(type, props2, rowPrefix) {
      ...
      function validateProperties$2(type, props2) {
      ...
      function warnUnknownProperties(type, props2, eventRegistry) {
        var unknownProps = [], key;
        for (key in props2)
          validateProperty(type, key, props2[key], eventRegistry) || unknownProps.push(key);
      ...
      function prepareToHydrateHostInstance(fiber) {
        ...
        var type = fiber.type, props2 = fiber.memoizedProps;
        didHydrate[internalInstanceKey] = fiber;
        didHydrate[internalPropsKey] = props2;
        validatePropertiesInDevelopment(type, props2);
        switch (type) {
          case "dialog":
      ...
      function renderWithHooks(current2, workInProgress2, Component, props2, secondArg, nextRenderLanes) {
        ...
        var children = callComponentInDEV(Component, props2, secondArg);
      ...
      function renderWithHooksAgain(workInProgress2, Component, props2, secondArg) {
        ...
        do {
          ...
          children = callComponentInDEV(Component, props2, secondArg);
      ...
      function validatePropertiesInDevelopment(type, props2) {
        validateProperties$2(type, props2);
        "input" !== type && "textarea" !== type && "select" !== type || null == props2 || null !== props2.value || didWarnValueNull || (didWarnValueNull = true, "select" === type && props2.multiple ? console.error(
        ...
        isCustomElement(type) || "string" === typeof props2.is || warnUnknownProperties(type, props2, eventRegistry);
          ...
          case "formAction":
            ...
            if ("function" === typeof value) {
              ...
              "function" === typeof prevValue && ("formAction" === key ? ("input" !== tag && setProp(domElement, tag, "name", props2.name, props2, null), setProp(
                ...
                props2,
                null
              ), setProp(domElement, tag, "method", props2.method, props2, null), setProp(
                domElement,
                tag,
                "target",
                props2.target,
                ...
                if (null != _propValue)
                  switch (hasSrc) {
                    ...
                    case "dangerouslySetInnerHTML":
                      ...
                      break;
                    default:
                      setProp(domElement, tag, hasSrc, _propValue, props2, null);
                  }
              }
      ...
      function resolveSingletonInstance(type, props2, rootContainerInstance, hostContext, validateDOMNestingDev) {
      ...
      function acquireSingletonInstance(type, props2, instance, internalInstanceHandle) {
        ...
        setInitialProperties(instance, type, props2);
      ...
      function isHostHoistableType(type, props2, hostContext) {
        ...
        if (hostContext.context === HostContextNamespaceSvg || null != props2.itemProp)
          return !outsideHostContainerContext || null == props2.itemProp || "meta" !== type && "title" !== type && "style" !== type && "link" !== type && "script" !== type || console.error(
        ...
        switch (type) {
          ...
          case "link":
            ...
            switch (props2.rel) {
              case "stylesheet":
                return type = props2.precedence, props2 = props2.disabled, "string" !== typeof type && outsideHostContainerContext && console.error(
                  'Cannot render a <link rel="stylesheet" /> outside the main document without knowing its precedence. Consider adding precedence="default" or moving it into the root <head> tag.'
                ), "string" === typeof type && null == props2;
              default:
                return true;
            }
          case "script":
            type = props2.async && "function" !== typeof props2.async && "symbol" !== typeof props2.async;
            if (!type || props2.onLoad || props2.onError || !props2.src || "string" !== typeof props2.src) {
              outsideHostContainerContext && (type ? props2.onLoad || props2.onError ? console.error(
      ...
      var callComponent = {
        react_stack_bottom_frame: function(Component, props2, secondArg) {
          var wasRendering = isRendering;
          isRendering = true;
          try {
            return Component(props2, secondArg);
          } finally {
...
var App = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto max-w-6xl h-screen flex flex-col justify-center px-6 py-12", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-center text-3xl font-bold text-gray-900", children: "Choose Your Plan" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-2 text-center text-gray-500", children: "Select a plan that works best for you" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-10 grid gap-8 grid-cols-3", children: PLANS.map((plan) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            isPro && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -top-3 right-6 rounded-full bg-indigo-600 px-3 py-1 text-xs font-semibold text-white", children: "Most Popular" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-xl font-semibold text-gray-900", children: plan.name }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-2 text-sm text-gray-500", children: plan.description }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-6 flex items-baseline justify-center gap-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-lg text-gray-500", children: "\u20B9" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-4xl font-bold text-gray-900", children: plan.amount })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                className: `mt-8 w-full rounded-xl px-4 py-3 text-sm font-semibold transition
                  ${status === "loading" && isSelected ? "cursor-not-allowed bg-gray-400" : "bg-indigo-600 text-white hover:bg-indigo-700"}`,
                children: status === "loading" && isSelected ? "Processing..." : "Pay Now"
              }
            )
          ]
        },
...
var props = typeof window !== "undefined" && window.__INITIAL_PROPS__ ? window.__INITIAL_PROPS__ : {};
(0, import_client.hydrateRoot)(document.getElementById("root"), /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(App_default, __spreadValues({}, props)));
